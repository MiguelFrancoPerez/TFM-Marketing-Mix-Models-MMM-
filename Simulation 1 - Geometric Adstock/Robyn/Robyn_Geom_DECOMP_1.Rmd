...
```{r}
#Step 2.a Load data
Data <- read.csv2("C:/Users/usuari/Dropbox/1.Estudos/A. MASTER (MESIO)/2º Master - 2º Q/Z. TFM - Adsmurai/4. UPC Bayesian/TFM - Simulations/Sim1-OBS_Data.csv")
head(Data)
tail(Data)

# Export results to desired directory.
robyn_object<- "C:/Users/usuari/Dropbox/1.Estudos/A. MASTER (MESIO)/2º Master - 2º Q/Z. TFM - Adsmurai/4. UPC Bayesian/TFM - Simulations/Robyn_Geom_DECOMP1_OUTPUT"
```
...
hyperparameters <- list(
  x.1._thetas = c(0.01, 0.9),
  x.2._thetas = c(0.01, 0.9),
  x.3._thetas = c(0.01, 0.9),
...
OutputModels <- robyn_run(
  ...
  objective_weights = c(1,1), #c(NRMS, DECOMP.RSSD) - Weights on the optimization objective function c(NRMS, DECOMP.RSSD)
